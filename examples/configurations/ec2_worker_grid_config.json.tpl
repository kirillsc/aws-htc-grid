{
  ...
  "ec2_pairs_per_instance": {{ec2_pairs_per_instance}},
  "ec2_pair_cpu": {{ec2_pair_cpu}},
  "ec2_pair_memory": {{ec2_pair_memory}},
  "orb_min_instances": {{orb_min_instances}},
  "orb_max_instances": {{orb_max_instances}},
  "orb_target_pending_per_instance": {{orb_target_pending_per_instance}},
